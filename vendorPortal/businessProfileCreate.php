            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 addProfileUserInner1">
              <form class="row g-3">
                ...
                <div class=" col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                  <label for="inputName4" class="form-label">Restauraunt Name</label>
                  <input type="text" class="form-control" id="inputName4" placeholder="Add Description">
                </div>
                <div class=" col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                  <label for="inputName4" class="form-label">Business Hours</label>
                  <input type="text" class="form-control" id="inputName4" placeholder="Add Description">
                </div>
                <div class=" col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                ...
                <div class=" col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                  <label for="inputName4" class="form-label">ID Card Front</label>
                  <input type="file" class="form-control" id="inputName4" placeholder="Add Description">
                </div>
                <div class=" col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                  <label for="inputName4" class="form-label">ID Card Back</label>
                  <input type="file" class="form-control" id="inputName4" placeholder="Add Description">
                </div>
