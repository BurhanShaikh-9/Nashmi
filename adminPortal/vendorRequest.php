                                ...
                                <a class="list-group-item list-group-item-action">
                                    <div class="rewardList">
                                        ...
                                        <div class=" w-100">
                                            ...
                                            <p class="mb-1">Request Description: Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid, facere. </p>
                                        </div>
                                    ...
                                    <div class="metaDatasDiv">
                                        ...
                                        <div>
                                            <p class="metaData"> Duration: 12/02/2023</p>
                                        </div>
                                        <div>
                                            <p class="metaData"> Membership: Lite</p>
                                        </div>
                                    </div>
                                    <div class="listButton">
                                        <button class="listEditButton">Accept</button>
                                        <button class="listDeleteButton">Reject</button>
                                    </div>
                                </a>
                                <a class="list-group-item list-group-item-action">
                                    <div class="rewardList">
