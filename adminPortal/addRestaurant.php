          ...
          <div class="row g-5 addProfileUserManagement">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 addProfileUserInner1">
              <form class="row g-3">
                ...
                <div class=" col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                  <label for="inputName4" class="form-label">Restaurant Description</label>
                  <input type="text" class="form-control" id="inputName4" placeholder="Add Description">
                </div>
                <div class=" col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                  <label for="inputState2" class="form-label">Delivery</label>
                ...
                <div class=" col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                  <label for="inputName4" class="form-label">About</label>
                  <input type="text" class="form-control" id="inputName4" placeholder="Add Description">
                </div>
                <div class=" col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                  <label for="inputState2" class="form-label">Manage Offers</label>
                  <select id="inputState2" class="form-select">
                    <option selected>Edit Offers</option>
                    <option>Delete Offers</option>
